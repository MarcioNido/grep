                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        {{ Form::activeText('Área Mínima', 'area_minima', $alerta->area_minima, ['style'=>'text-align: right;', 'placeholder' => 'Indiferente']) }}
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        {{ Form::activeText('Área Máxima', 'area_maxima', $alerta->area_maxima, ['style'=>'text-align: right;', 'placeholder' => 'Indiferente']) }}
                                    </div>

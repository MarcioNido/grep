                ...
                <?php } else { ?>
                    <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <label>Gostaria de ser atendido por um outro profissional ?</label>
                                </div>
                                <div class="col-md-2">
                                    {{ Form::activeDropDownList('', 'outro_profissional', $model->outro_profissional, DropDownTool::getSimNaoBoolean(), array('class'=>'form-control guru-select', 'placeholder'=>'...')) }}
                                </div>
                                <div class="col-md-5">

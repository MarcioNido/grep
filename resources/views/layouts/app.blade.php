...
<body>
    ...
    <footer class="footer" style="background-color: #345C8C;">
        <div class="container">
            <p class="pull-left" style="color: #FFFFFF;">&copy; Paulo Roberto Leardi <?= date('Y') ?>
                <span style="color: #BBBBBB"> - As informações aqui constantes são fornecidas pelo proprietário do imóvel e estão sujeitas a alteração a qualquer momento.</span>
                <span style="color: #BBBBBB"> - Cada unidade é juridica e financeiramente independente e registrada no Creci.</span>
            </p>
            <!--
